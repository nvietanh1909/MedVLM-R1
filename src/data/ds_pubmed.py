...
def _build_records(data_path, json_file, max_samples=None, offset=0):
...
class PubMedVisionGRPO:
    def __init__(self, data_path, json_file, max_samples=None, offset=0):
        self.data = _build_records(data_path, json_file, max_samples, offset)
